...
```js
const selected = view(searchCheckbox(names, { urlParam: "q", value: ["Boston", "Cambridge"]}));
```
...
Want to dive deeper into a specific municipality's finances? Visit our [detailed municipal profiles page](/data/municipalities) to see comprehensive financial data, including historical trends, debt levels, and detailed budget breakdowns for individual communities.
